...
# data, generated with the following parameters (plus errors):
# r0 = 3.5
# c1 = 2
# c2 = 4
# l1 = 2
...
dat = np.array([
    [
        ...
        4.80000, 5.00000, 5.20000, 5.40000, 5.60000, 5.80000, 6.00000, 6.20000,
        6.40000, 6.60000, 6.80000, 7.00000, 7.20000, 7.40000, 7.60000, 7.80000,
        8.00000, 8.20000, 8.40000, 8.60000, 8.80000, 9.00000, 9.20000, 9.40000,
        9.60000, 9.80000, 0.00000
    ], [
...
def ded(ord, x):
    ...
    Unlike the other methods that accept three argument, this only accepts x
    as an np.array().
    """

    x = x.flatten()  # in case it was passed as 2-d array.
    # n = x.size  # BUG variable not used
    J, _ = dat.shape
